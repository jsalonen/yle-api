# yle-api [![Build Status](https://travis-ci.org/jsalonen/yle-api.svg?branch=master)](https://travis-ci.org/jsalonen/yle-api) [![Coverage Status](https://coveralls.io/repos/jsalonen/yle-api/badge.png?branch=master&service=github)](https://coveralls.io/github/jsalonen/yle-api?branch=master)
